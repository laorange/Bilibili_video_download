...
# fork from https://github.com/Henryhaohao/Bilibili_video_download
# edit by GitHub@laorange
...
if __name__ == '__main__':
    ...
    url = input('请输入您要下载的视频链接地址:')
    if bv_search := re.search(r'/(BV\w+)/?.*', url):
        start_url = "https://api.bilibili.com/x/web-interface/view?bvid=" + bv_search.group(1)
    elif av_search := re.search(r'/(av\d+)/?.*', url):
    ...
    print("请选择视频的清晰度：\n【1】320p\n【2】480p\n【3】720p\n【4】1080p")
    quality = input("请输入对应的数字：")
    # "1080p:80;720p:64;480p:32;360p:16"
    while quality not in quality_choice.keys():
        print("☠您的输入不正确☠")
        print("请选择视频的清晰度：\n【1】320p\n【2】480p\n【3】720p\n【4】1080p")
        quality = input("请输入对应的数字：")
